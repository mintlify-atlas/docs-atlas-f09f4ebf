...
<ParamField path="icon" type="string" default="/icon/terminal.svg">
  The icon to use for the startup script.
</ParamField>

<ParamField path="display_name" type="string" default="Start ET + SSHD">
  Display name for the startup script.
</ParamField>

<ParamField path="et_port" type="number" default="2022">
  Port for etserver.
</ParamField>

<ParamField path="ssh_port" type="number" default="2244">
  Port for internal sshd used by ET handshakes.
</ParamField>

<ParamField path="bind_ip" type="string" default="127.0.0.1">
  Bind address for etserver and sshd.
</ParamField>

<ParamField path="ssh_user" type="string" default="coder">
  Allowed SSH user for internal sshd.
</ParamField>
